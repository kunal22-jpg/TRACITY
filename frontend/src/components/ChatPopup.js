...
const ChatPopup = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="bg-slate-900/95 backdrop-blur-md border border-purple-500/30 rounded-2xl w-full max-w-2xl h-[600px] flex flex-col overflow-hidden relative chatbot-container"
      ...
      >
        ...
        {/* Chat Content Area with Scroll Bar */}
        <div className="flex-1 overflow-hidden relative z-10">
            ...
            {isLoading && (
              ...
              >
                ...
                >
                  ...
                  <p className="text-slate-400 text-sm">Analyzing your query...</p>
                </motion.div>
          ...
          {/* Messages Area with Scroll Bar */}
          <div className="flex-1 max-h-[400px] overflow-y-auto p-4 space-y-4 chat-messages-scrollbar">
